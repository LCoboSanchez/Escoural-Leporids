...
library(DescTools)
library(ggplot2)
data<-read.csv("6_pits_punct_Esc.csv", sep=";", header=TRUE)
...
data_all<-read.csv("6_pits_punct_all_rr.csv",sep=";",header=TRUE)
...
ggsave("Figure9r.png", plot = plot, width = 10, height = 8, dpi = 300)
